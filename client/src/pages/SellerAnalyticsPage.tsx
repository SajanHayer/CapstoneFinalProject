        ...
        const fetchData = async () => {
            try {
                ...
                const listingRes = await fetch(
                    `http://localhost:8080/api/listings-analytics/${listingId}`,
                    { credentials: "include" }
                );

                if (!listingRes.ok) throw new Error("Failed listing fetch");
                ...
                if (!bidsRes.ok) throw new Error("Failed bids fetch");
