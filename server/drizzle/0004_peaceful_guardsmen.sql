...
ALTER TABLE "vehicles" ADD COLUMN "vin" varchar(255);--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "style" varchar(255);--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "engine_size" numeric(8, 2);--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "engine_size_unit" varchar(10);--> statement-breakpoint
